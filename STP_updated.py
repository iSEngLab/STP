...
if not os.path.exists(f"target_sentences_custom_{dataset}_{model_checkpoint_name}.pkl"):
...
with open(f"target_sentences_custom_{dataset}_{model_checkpoint_name}.pkl", "rb") as f:
